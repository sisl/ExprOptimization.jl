...
def evalSymbReg(individual):
    ...
    los = 0.0
    n = 0.0
    for x in numpy.linspace(-3.0,3.0,20):
        for y in numpy.linspace(-3.0,3.0,20):
...
def main():
    n_seeds = 50
    with open('../results/deap_keijzer_11.csv', 'wb') as csvfile:
        ...
        for n_pop in pop_sizes:
            ...
            w.writerow(['deap', 'keijzer_11', n_seeds, n_pop, mean_time_s, std_time_s, mean_fitness, std_fitness])
